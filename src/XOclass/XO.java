...
public class XO {
    ...
    public XO() {
        ...
        jugadores[0]="Jugador1- "+X;
        jugadores[1]="Jugador2- "+o;
        b=new File("ArchivoXO.txt");
    ...
    switch (opc){
        case 1:
            ...
            if(name.equals(jugadores[1])||  name.equals(jugadores[0])){
                System.out.println("Ingrese otro nombre que no este en uso");
            }else{
        ...
        case 2:
            ...
            break;
        default:
            System.out.println("Ingrese que una opcion sea valida");
            break;
    }
 ...
 public static void muestraContenido(String archivo) throws FileNotFoundException, IOException {
  ...
  for (int y=0; y < tablero[x].length; y++) {
    ...
    public void jugar(){
        ...
        System.out.println("Elcturno se escoje automaticamente");
        ...
        if(turno.equals(X)){
            ...
            System.out.println("Turno del "+jugadores[0]);
            ...
            if(ganador==true){
            try{  
                String b="El ganador fue: "+ jugadores[0];
            ...
            fileSaver(b);
                ...
                System.out.println("Espacio no dispoible");
        }
            
        }else if(turno.equals(o)){
            System.out.println("Turno del "+jugadores[1]);
           System.out.println("fila: ");
            int q=leer.nextInt();
            System.out.println("Columna: ");
            int w=leer.nextInt();
            ...
            if(ganador==true){
              try{  
                String b="El ganador fue: "+ jugadores[1];
